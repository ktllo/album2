...
CREATE TABLE GROUP_PERMISSION(
	...
	CONSTRAINT PRIMARY KEY (GROUP_ID, OBJECT_ID),
	CONSTRAINT FOREIGN KEY (GROUP_ID) REFERENCES GROUPS(GROUP_ID),
...
CREATE TABLE USER_PERMISSION(
	...
	PERM_EDIT CHAR(1) NOT NULL DEFAULT 'N',
	PERM_THUMBNAIL_GEN CHAR(1) NOT NULL DEFAULT 'N',
	CONSTRAINT PRIMARY KEY (USER_ID, OBJECT_ID),
	CONSTRAINT FOREIGN KEY (USER_ID) REFERENCES USERS(USER_ID),
	CONSTRAINT FOREIGN KEY (OBJECT_ID) REFERENCES PERMISSION_OBJECT(OBJECT_ID)
);
CREATE TABLE GROUP_EXT_PERMISSION(
	...
	CONSTRAINT PRIMARY KEY (GROUP_ID, OBJECT_ID, PERM_NAME),
	CONSTRAINT FOREIGN KEY (GROUP_ID) REFERENCES GROUPS(GROUP_ID),
	CONSTRAINT FOREIGN KEY (OBJECT_ID) REFERENCES PERMISSION_OBJECT(OBJECT_ID)
);
CREATE TABLE USER_EXT_PERMISSION(
	...
	PERM_NAME VARCHAR(255) COLLATE LATIN1_GENERAL_CI,
	PERM_VALUE CHAR(1) NOT NULL DEFAULT 'N',
	CONSTRAINT PRIMARY KEY (USER_ID, OBJECT_ID, PERM_NAME),
	CONSTRAINT FOREIGN KEY (USER_ID) REFERENCES USERS(USER_ID),
	CONSTRAINT FOREIGN KEY (OBJECT_ID) REFERENCES PERMISSION_OBJECT(OBJECT_ID)
);
